---
title: "Infinity categories (2021)"
excerpt: "This is the website of a working group on Infinity categories organized by me together with [Johannes Huisman](http://huisman.perso.math.cnrs.fr/) and Pierre Martinez at the [LMBA](http://www.math.univ-brest.fr/) in Brest, France."
collection: workinggroups
permalink: /working-groups/infcat
type: workinggroups
KaTeX: true
---
...
There's also a website of a working group organized in Paris 13 on the same subject, which by the way is very complete and contains a lot of stuff (if someone wants to talk about one of the topics treated at the time, he is strongly invited to do so). You can have access [here](https://www.math.univ-paris13.fr/~vallette/GdT%20Categories%20infinies.html).

**References:**

1. "[Lectures on n-categories and cohomology](https://arxiv.org/pdf/math/0608420.pdf)", John C. Baez, Michael Shulman

2. "The homotopy theory of $$(\infty, 1)$$-categories", Julia Bergner

3. "[A survey of (\infty, 1)-categories](https://arxiv.org/pdf/math/0610239.pdf)", Julia Bergner

4. "Introduction to $$\infty$$-categories", Markus Land

5. "[Higher topos theory](https://www.math.ias.edu/~lurie/papers/HTT.pdf)", Jacob Lurie

6. "[Higher algebra](https://www.math.ias.edu/~lurie/papers/HA.pdf)", Jacob Lurie


*Other references:*

7. "Higher categories and homotopical algebra", Denis-Charles Cisinski.

8. "Simplicial homotopy theory", Paul Goerss, Rick Jardine

9. "[Model categories](https://people.math.rochester.edu/faculty/doug/otherpapers/hovey-model-cats.pdf)", Mark Hovey

10. "[Notes on quasi-categories](https://www.math.uchicago.edu/~may/IMA/Joyal.pdf)", André Joyal
...
| Simplical categories I (Oct 11 - In French)   | Pierre Martinez  | [SimplicialCatsI](https://youtu.be/_ywwNbnhpZ4) |
